#common config für Abiturmottos, durchsucht alle deutschen Wörter nach substrings 'abi' und 'api', Maximallänge auf 15 gesetzt

#HIER GESUCHTE WÖRTER/BUCHSTABENFOLGEN IN DIE LISTE EINTRAGEN
searched_word_list = ["abi","Abi","api"]#gesuchte Wörter

#HIER DATEI EINGEBEN, IN WELCHE DIE ERGEBNISSE GESPEICHERT WERDEN
targetfile = "abi_Ideen.txt"#Detei, in welche Ergebnisse gespeichert werden
